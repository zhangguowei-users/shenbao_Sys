        ...
        renderData: function (R)
        {
            ...
            if (_cascade === false)
            {
                _searchHtml = [
                    ...
                    '<input class="layui-input search_condition" style="width:376px;float:right;margin-top: -2px;" placeholder="关键字搜索">',
            ...
            var outHtml =
                $(config.elem).html([
                    '<div class="transfer-content" style="width: 1000px;height: 450px;position: relative">',
                    ...
                    '<a title="右移" lay-name="' + _name + '" class="layui-btn layui-btn-useradmin layui-btn-sm layui-btn-disabled"><i class="layui-icon">&#xe65b;</i></a>',
                    '</div>',
                    '<div class="transfer-btn  transfer-to-left">',
                    '<a title="左移" lay-name="' + _name + '"  class="layui-btn layui-btn-useradmin layui-btn-sm layui-btn-disabled"><i class="layui-icon">&#xe65a;</i></a>',
                    '</div>',
